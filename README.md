...
هذا الكود **إطار عمل هندسي (scaffold)** يترجم القرارات الاستراتيجية والشرعية التي
اتفقنا عليها إلى بنية برمجية واضحة — وليس نظاماً جاهزاً للتشغيل بأموال حقيقية بشكل
فوري. كل نقطة TODO تمثل قراراً تقنياً حساساً (خاصة توقيع المعاملات ببيتك الخاص)
يستحق وقتاً كافياً للاختبار قبل أي التزام مالي حقيقي.
